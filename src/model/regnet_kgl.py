...
class RegNet(nn.Module):
    def __init__(
        ...
        # add kgl
        self.kgl = KernelGaussianLayer(in_channels=current_width, mu_threshold=mu_threshold)
...
def _regnet(arch: str, block_params: BlockParams, pretrained: bool, progress: bool, **kwargs: Any) -> RegNet:
    return RegNet(block_params, norm_layer=partial(nn.BatchNorm2d, eps=1e-05, momentum=0.1), **kwargs)
...
if __name__ == "__main__":
    ...
    model = regnet_y_400mf(mu_threshold=0.2, in_channels=1)
    print(model)
