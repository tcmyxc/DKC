...
class Xception(nn.Module):
    ...
    def __init__(self, block, in_channels=3, num_classes=10, mu_threshold=0.5):
        super().__init__()
...
def xception(in_channels=3, num_classes=10, **kwargs):
    return Xception(MiddleFLowBlock, in_channels=in_channels, num_classes=num_classes, **kwargs)

if __name__ == "__main__":
    from torchsummary import summary
    model = xception(mu_threshold=0.2)
    print(model)
