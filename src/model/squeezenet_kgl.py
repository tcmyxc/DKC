...
def squeezenet(in_channels=3, num_classes=10, **kwargs):
    return SqueezeNet(in_channels=in_channels, num_classes=num_classes, **kwargs)

if __name__ == "__main__":
    from torchsummary import summary
    model = squeezenet(mu_threshold=0.2)
    print(model)
