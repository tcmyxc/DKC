...
class MnasNet(nn.Module):
    def __init__(self, in_channels=3, num_classes=10, input_size=224, width_mult=1., mu_threshold=0.5):
        ...
        self.features = [Conv_3x3(in_channels, input_channel, 2), SepConv_3x3(input_channel, 16)]
        input_channel = 16
        ...
        # add kgl
        self.kgl = KernelGaussianLayer(in_channels=self.last_channel, mu_threshold=mu_threshold)
...
def mnasnet(in_channels=3, num_classes=10, **kwargs):
    return MnasNet(in_channels=in_channels, num_classes=num_classes, **kwargs)


if __name__ == "__main__":
    from torchsummary import summary
    model = mnasnet(mu_threshold=0.2)
    print(model)
